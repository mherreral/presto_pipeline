...
try:
    ...
    FFT info:
        datfiles: %i
        Total time: %f
        prom time: %f ''' %(len(datfiles), total, prom)
    ...
    ACCEL info:
        fftfiles: %i
        total: %f
        prom: %f ''' %(len(fftfiles), total, prom)
